...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        configProps.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS + "." + JsonDeserializer.VALUE_DEFAULT_TYPE, "com.moviebooking.ticket.events.BookingConfirmedEvent");
        configProps.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS + "." + JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        configProps.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS + "." + JsonDeserializer.TYPE_MAPPINGS, "bookingConfirmedEvent:com.moviebooking.ticket.events.BookingConfirmedEvent");
